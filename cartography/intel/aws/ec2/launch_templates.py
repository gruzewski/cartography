...
@timeit
@aws_handle_regions
def get_launch_templates(boto3_session: boto3.session.Session, region: str, aws_endpoint: str) -> List[Dict]:
...
def sync_ec2_launch_templates(
    ...
    for region in regions:
        ...
        data = get_launch_templates(boto3_session, region, aws_endpoint)
